...
to render these predictions into either UIView or NSView, dependong on the platform.
                       DESC

  s.homepage         = 'https://github.com/abamaxa/coreml_ssd'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Chris Morgan' => 'cmorgan@abamaxa.com' }
  s.source           = { :git => 'git@github.com:abamaxa/coreml_ssd.git', :tag => s.version.to_s }

  s.ios.deployment_target = '11.0'
  s.osx.deployment_target = '10.13'

  s.source_files = 'Classes/*.{m,mm,cpp}'
  s.ios.source_files = 'Classes/ios/*.m'
